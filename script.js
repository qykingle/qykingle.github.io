...
const helpContent = {
  shellType: {
    header: '烟花类型',
    body: '将发射的烟花类型。选择“随机”以获得不错的体验',
  },
  shellSize: {
    header: '大小',
    body: '烟花的大小。仿照真实的烟花炮弹尺寸，更大的炮弹有更大的爆发，有更多的星星，有时还有更复杂的效果。但是，更大的外壳也需要更多的处理能力，并且可能会导致延迟。',
  },
  quality: {
    header: '质量',
  ...
  skyLighting: {
    header: '照亮',
    body: '在烟花爆炸时照亮背景。如果屏幕上的背景看起来太亮，请尝试将其设置为“暗淡”或“无”。',
  },
  scaleFactor: {
    header: '缩放',
    body: '允许缩放所有烟花的大小，本质上是让你更近或更远。对于较大的外壳尺寸，将比例缩小一点会很方便，尤其是在手机或平板电脑上。',
  },
  autoLaunch: {
    header: '自动开火',
  ...
  finaleMode: {
    header: '爆炸就是艺术',
    body: '发射强烈的烟花爆裂。可能会导致滞后。需要启用“自动开火”。',
  },
  hideControls: {
    header: '隐藏控件',
    body: '隐藏屏幕顶部的半透明控件。对屏幕截图很有用，或者只是更无缝的体验。隐藏时，您仍然可以点击右上角重新打开此菜单。',
  },
  fullscreen: {
    header: '全屏',
    body: '开启全屏模式',
